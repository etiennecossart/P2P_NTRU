...
import (
	...
	"github.com/etiennecossart/P2P_NTRU/crypto"
	"github.com/etiennecossart/P2P_NTRU/crypto/blake2b"
	"github.com/etiennecossart/P2P_NTRU/crypto/ed25519"
	"github.com/etiennecossart/P2P_NTRU/internal/test/protobuf"
	"github.com/etiennecossart/P2P_NTRU/network"
	"github.com/etiennecossart/P2P_NTRU/network/discovery"
	"github.com/etiennecossart/P2P_NTRU/peer"
	"github.com/etiennecossart/P2P_NTRU/types/opcode"
)
